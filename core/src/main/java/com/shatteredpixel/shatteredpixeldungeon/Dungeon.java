...
import com.shatteredpixel.shatteredpixeldungeon.levels.BattleLevel;
...
public class Dungeon {
	...
	// Sprouted branch quest-artifact flags. True once each piece has been dropped on its floor.
